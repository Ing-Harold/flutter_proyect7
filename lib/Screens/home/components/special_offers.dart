...
import 'package:flutter_proyect7/Screens/home/components/section_title.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: press,
        child: SizedBox(
          width: (242 / 375.0) * _mediaQueryData.size.width,
          height: (100 / 375.0) * _mediaQueryData.size.width,
          child: ClipRRect(
            ...
            child: Stack(
              children: [
                ...
                Padding(
                  padding: EdgeInsets.symmetric(
                    horizontal: (15 / 375.0) * _mediaQueryData.size.width,
                    vertical: (10 / 375.0) * _mediaQueryData.size.width,
                  ),
                  child: Text.rich(
                    TextSpan(
